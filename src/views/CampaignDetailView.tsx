...
import { tooltipInt, tooltipIntOnly } from '../lib/chart';
import MetricTile from '../components/MetricTile';
import { Button, Card, EmptyState, Pill, SectionTitle, Td, Th } from '../components/primitives';
...
function useAxisStyle() {
  ...
  return {
    ...
    tooltipStyle: {
      ...
      color: theme === 'dark' ? '#ececec' : '#282929',
    },
  };
}
...
export default function CampaignDetailView() {
  ...
  // exists.
  const inScope = !fetched || role === 'brame_admin' || fetched.companyId === companyId;
